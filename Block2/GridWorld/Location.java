...
public class Location implements Comparable
{
     ...
     * @return true if other is a Location with the same row and column as this location; false otherwise */
    ...
    /* Compares this location to other for ordering. Returns a negative integer, zero, or a positive integer as this location is less
     * than, equal to, or greater than other. Locations are ordered in row-major order. 
     * (Precondition: other is a Location object.)
     * @param other the other location to test
     * @return a negative integer if this location is less than
     * other, zero if the two locations are equal, or a positive integer if this location is greater than other */
